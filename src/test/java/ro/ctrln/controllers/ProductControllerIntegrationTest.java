...
public class ProductControllerIntegrationTest {
    ...
    public void addProduct_whenUserIsAdmin_shouldStoreTheProduct(){
        ...
        assertThat(product.getCurrency()).isEqualTo(Currencies.USD);

    }

    @Test
    public void addProduct_whenUserIsNotAdmin_shouldStoreTheProduct(){
//        productRepository.deleteAll();
        User user = getUserWithRole(Roles.CLIENT);//"Role" adica utilizator
        ProductDTO productDTO = new ProductDTO();
        productDTO.setCode("aProductCode");
        productDTO.setPrice(100);
        productDTO.setCurrency(Currencies.USD);
    ...
    @Test
    public void addProduct_whenUserIsNotInDB_shouldStoreTheProduct(){
        ProductDTO productDTO = new ProductDTO();
        productDTO.setCode("aProductCode");
        productDTO.setPrice(100);
        productDTO.setCurrency(Currencies.USD);
...
//        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.INTERNAL_SERVER_ERROR);//Aici trebuia sa fie "BAD_REQUEST"
//        assertThat(response.getBody()).isEqualTo("Customer Id is invalid!"); //e o greseala undeva in "Insomnia" + in DB
    }

    @Test
    public void getProductByCode_whenCodeIsPresentInBD_shouldReturnTheProduct(){
    ...
    @Test
    public void getProductByCode_whenCodeIsNotPresentInBD_shouldReturnErrorMessage(){
    ...
    public void getProducts(){
        ...
        ResponseEntity<List<ProductDTO>> response =
                testRestTemplate.
                        exchange(LOCALHOST + port + "/product",
                                HttpMethod.GET, null,
    ...
    public void deleteProduct_whenUserIsAdmin_shouldDeleteProduct(){
        ...
        User user = getUserWithRole(Roles.ADMIN);
                                                                                       ...
                                                                                       //  ↓ asta este adminul gen "/1" dar mai corect e asa user.getId()
