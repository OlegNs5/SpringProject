...
@RunWith(SpringRunner.class) // folosim @RunWith si SpringRunner ca sa rulam teste  de JUnit4.13.2
...
public class ProductRepositoryIntegrationTest {
    ...
    public void findByCode_whenCodeIsPresentInDB_shouldReturnTheProduct(){
        ...
        productOne.setDescription("A beautiful productTwo!");
    ...
    public void findByCode_whenCodeIsNotPresentInDB_shouldReturnEmpty(){
        Optional<Product> optionalProduct = productRepository.findByCode("some codes");
